...
export const getBookmarkedPosts = async (bookmarkedIds) => {
  try {
    const promises = bookmarkedIds.map(id => databases.getDocument(databaseId, videoCollectionId, id));
...
export async function deleteDocument(documentId) {
  try {
    await databases.deleteDocument(databaseId, videoCollectionId, documentId);
